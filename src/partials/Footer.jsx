      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          <div className="sm:col-span-12 lg:col-span-2">
            ...
            <ul className="flex mb-4  md:mt-10 md:mb-0">
            <li>
        ...
        {/* Bottom area */}
        <div className="md:flex md:items-center text-center md:justify-center py-4 md:py-8 border-t border-gray-200">

          {/* Social links */}
        

          {/* Copyrights note */}
          <div className="text-sm text-gray-600 mr-4">Made by <a className="text-blue-600 hover:underline" href="#">Saiful</a>. All rights reserved.</div>
